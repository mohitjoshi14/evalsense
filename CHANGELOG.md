...
- **CLI**: `npx evalsense docs` command — prints the full assertion API reference (metrics, matchers, examples, dataset requirements) for use by coding agents and developers
